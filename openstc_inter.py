...
class project(osv.osv):
    ...
    _actions = {
        ...
        'plan_unplan':lambda self,cr,uid,record: (record.state == 'open' and not self.pool.get("project.task").search(cr, uid,[('state','=','draft'),('project_id','=',record.id)])) or record.state == 'pending' ,
